...
`Airsafety` package contains the airline safety data and includes a Shiny Application for user to interactively learn more about safety of airlines around the world.
...
To run the shiny application, with the following code:
...
- `airline_rating0()` : state the rating in sentence
...
For more information about the functions mentioned above and the functions use in the Shiny Application included in the `Airsafety` package, please refer to the [pkgdown]() site.
